...
export default async function Home() {
    ...
    return (
        <>
            ...
            <Separator/>
            <Section description={t("home.start.description")} background={"/image/background/starting.jpg"}
...
async function CardList({backgroundImage, titleId, descriptionId, t}) {
    return (
        <li key={titleId}
            className={"h-72 flex-1 text-center bg-cover bg-center rounded-lg flex justify-center items-center"}
